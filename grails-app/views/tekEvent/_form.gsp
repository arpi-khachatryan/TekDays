...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'startDate', 'error')} required">
    ...
    <g:datePicker name="startDate" precision="day" value="${tekEventInstance?.startDate}" years="${2008..currentYear}"/>tekdays
</div>
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'endDate', 'error')} required">
    ...
    <g:datePicker name="endDate" precision="day" value="${tekEventInstance?.endDate}" years="${2019..2024}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'volunteers', 'error')} ">
    ...
    <g:select name="volunteers" from="${TekUser.list()}" multiple="multiple" optionKey="id" size="5"
