...
%{--					<g:link class="list" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link>--}%
				...
				<g:link class="list" action="index" id="${tekMessageInstance?.event?.id}"><g:message code="default.list.label" args="[entityName]" /></g:link>
...
%{--			<h1><g:message code="default.create.label" args="[entityName]" /></h1>--}%
			...
			<g:form url="[resource:tekMessageInstance, action:'save']" >
				<fieldset class="form">
					<g:render template="form" model="[aa:1]"/>
							</fieldset>
