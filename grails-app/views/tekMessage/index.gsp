...
<div class="nav" role="navigation">
    <ul>
        ...
        <li>
            ...
            <g:link class="create" action="create" params='["event.id": "${event?.id}"]'><g:message
    ...
    <table>
        ...
        <g:each in="${tekMessageInstanceList}" status="i" var="tekMessageInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                <td><g:link action="show" id="${tekMessageInstance.id}">
                    ${fieldValue(bean: tekMessageInstance, field: "subject")}</g:link>
                </td>
